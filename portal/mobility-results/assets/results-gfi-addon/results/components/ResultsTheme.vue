        ...
        >
            <tbody v-if="mappedPropertiesExists(feature)">
                ...
                >
                    ...
                    <td v-if="key === 'Bilder' && value.length > 0">
                        <img
                            :src="'https://re2-api-internal.cut.hcu-hamburg.de/' + value[0]"
                            class="result_image"
                            @click="openInNewTab('https://re2-api-internal.cut.hcu-hamburg.de/' + value[0])"
                        >
                    </td>
                    <td v-else-if="key === 'Audio' && value.length > 0 && value[0] !== null">
                        <audio controls>
                            <source
                                :src="'https://re2-api-internal.cut.hcu-hamburg.de/' + value[0]"
                                type="audio/mp4"
